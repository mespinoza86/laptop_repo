...
TARGET_CPPFLAGS += -mcpu=cortex-a9 -mfpu=neon -ftree-vectorize -O3 -pthread -Wl,-rpath -Wl,$(HOST_MPI_LIB)/lib/ -Wl,--enable-new-dtags -L$(HOST_MPI_LIB)/lib/ -L$(HOST_MPI_LIB)/lib/ -lmpi -I$(UDMABUFTEST_LIB)/include -I$(HOST_MPI_LIB)/lib/
